 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query getArticleGroupPageItems($key: String!, $locale: [Locales], $pageSize: Int, $skip: Int, $orderBy: ArticlePageOrderByInput) {\n  group: ArticleGroupPage(where: {_metadata: {key: {eq: $key}}}, locale: $locale) {\n    data: items {\n      children: _link(type: ITEMS) {\n        listing: ArticlePage(\n          limit: $pageSize\n          orderBy: $orderBy\n          locale: $locale\n          skip: $skip\n        ) {\n          total\n          items {\n            ...IContentData\n            _metadata {\n              published\n            }\n            articleHeroImage {\n              ...ReferenceData\n            }\n            articleTitle\n            articleSummary {\n              json\n            }\n          }\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query getArticleGroupPageItems($key: String!, $locale: [Locales], $pageSize: Int, $skip: Int, $orderBy: ArticlePageOrderByInput) {\n  group: ArticleGroupPage(where: {_metadata: {key: {eq: $key}}}, locale: $locale) {\n    data: items {\n      children: _link(type: ITEMS) {\n        listing: ArticlePage(\n          limit: $pageSize\n          orderBy: $orderBy\n          locale: $locale\n          skip: $skip\n        ) {\n          total\n          items {\n            ...IContentData\n            _metadata {\n              published\n            }\n            articleHeroImage {\n              ...ReferenceData\n            }\n            articleTitle\n            articleSummary {\n              json\n            }\n          }\n        }\n      }\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
